...
export class DoctorListComponent implements OnInit {
  ...
  public doctorList: Array<DoctorList> = [];
  ...
  private getTableData(page = 1): void {
    ...
    this.doctorService.list(this.currentPage, this.pageSize, this.searchDataValue, this.sortBy, this.sortDirection).subscribe({
