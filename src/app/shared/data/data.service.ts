          ...
          subMenus: [
            {
              ...
              route: routes.addRoleUser,
              base: routes.addRoleUser,
              permision: 'register_rol',
              showNav: true,
            },
            {
              menuValue: 'Listado',
              route: routes.roleUserList,
              base: routes.roleUserList,
              permision: 'list_rol',
              showNav: true,
            },
            {
  ...
  public sideBarMedical = [
    {
      ...
      menu: [
        ...
        },
        {
          ...
          subMenus: [
            {
              menuValue: 'Listar Especialidad',
              route: routes.specialtyList,
              base: routes.specialtyList,
              permision: 'list_specialty',
              showNav: true,
            },
            {
              menuValue: 'Agregar Especialidad',
              route: routes.addSpecialty,
              base: routes.addSpecialty,
              permision: 'register_specialty',
              showNav: true,
            },
            {
              menuValue: 'Edit Specialty',
              route: '',
              base: '',
              permision: 'edit_specialty',
              showNav: false,
