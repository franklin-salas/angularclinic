export class routes {
  ...
  public static get changePassword2(): string {
    return this.baseUrl + 'auth/change-password2';
  }
  ...
  public static get doctorList(): string {
    return this.baseUrl + '/doctor/doctor-list';
  }
  ...
  public static get patientList(): string {
    return this.baseUrl + '/patient/patient-list';
  }
  // -------------------------------
...
// --------------------------------------------
  ...
  public static get addSpecialty(): string {
    return this.baseUrl + '/specialty/add-specialty';
  }

  public static get editSpecialty(): string {
    return this.baseUrl + '/specialty/edit-specialty';
  }
...
// ------------------------------------------------
  public static get addRoleUser(): string {
    return this.baseUrl + '/roles/add-role-user';
  }
  public static get editRoleUser(): string {
    return this.baseUrl + '/roles/edit-role-user';
  }
  public static get roleUserList(): string {
    return this.baseUrl + '/roles/role-user-list';
  }
